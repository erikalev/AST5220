module params
  ...
  real(dp), parameter :: Omega_b0      = 0.046d0
  real(dp), parameter :: Omega_m0      = 0.224d0
  real(dp), parameter :: Omega_r0      = 8.3d-5
  real(dp), parameter :: Omega_nu0     = 0.d0
  ! If you want neutrinos, use the two below
!  real(dp), parameter :: Omega_r      = 5.04d-5
!  real(dp), parameter :: Omega_nu     = 8.3d-5 - Omega_r
  real(dp), parameter :: Omega_lambda0 = 1.d0 - Omega_m0 - Omega_b0 - Omega_r0 - Omega_nu0
